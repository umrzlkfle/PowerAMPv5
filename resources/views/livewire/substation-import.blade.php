<!-- resources/views/pages/substations-upload.blade.php -->
<div class="main-content">
        ...
        <div class="row gx-4">
            <div class="col-auto">
                <div class="avatar avatar-xl position-relative">
                    <img src="{{ asset('assets/img/illustrations/power-plant.png') }}" alt="Substation icon" class="w-100 border-radius-lg shadow-sm">
                </div>
            </div>
            <div class="col-auto my-auto">
                <div class="h-100">
                    <h5 class="mb-1">
                        Substations CSV Upload Center
                    </h5>
                    <p class="mb-0 font-weight-bold text-sm">
                        Upload your substation data in CSV format
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-gray-50 m-4 p-4 rounded-lg border border-gray-200">
        ...
        <ul class="text-sm text-gray-600 list-disc pl-5 space-y-1">
            ...
            <li>Required columns: <span class="font-mono bg-gray-100 px-1 rounded">substation_id</span>, <span class="font-mono bg-gray-100 px-1 rounded">name</span></li>
            <li>Latitude and longitude should be in decimal format</li>
    ...
    <div class="max-w-4xl m-4 p-4 bg-white rounded shadow">
        <form wire:submit.prevent="import">
            <div class="mb-4">
                ...
                <input type="file" wire:model="csv_file" accept=".csv"
            ...
            {{-- Progress bar --}}
            <div wire:loading wire:target="csv_file" class="w-full bg-gray-200 rounded h-4 mb-4">
    ...
    <div class="max-w-full mx-4">
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div class="flex items-center justify-between p-4">
                <h2 class="text-xl font-bold text-gray-800">Preview of Recently Uploaded Substation Data</h2>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($existingSubstations as $index => $substation)
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                @foreach(array_keys($existingHeaders) as $header)
                        ...
                        @empty
                            <tr>
                                <td colspan="{{ count($existingHeaders) + 1 }}"
            ...
            <div class="px-4 py-3 bg-gray-50 border-t border-gray-200">
                {{ $existingSubstations->links('livewire::bootstrap') }}
            </div>
        </div>
    </div>
    @endif
    ...
    <div class="container-fluid py-4">
        @include('components.tables.substations')
    </div>
